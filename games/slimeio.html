<!DOCTYPE html>
<base href="https://cdn.jsdelivr.net/gh/bubbls/youtube-playables@main/slime-io/">
<script nonce="CA2QrendWiTeO_qSXS8GQQ">
    (function () {
        'use strict';
        ...
        function v(a, b) {
            if (b) a: {
                ...
                a = a[a.length - 1];f = e[a];b = b(f);b != f && b != null && r(e, a, {
                    configurable: !0,
                    writable: !0,
                    value: b
                })
        ...
        v("Promise", function (a) {
            ...
            b.prototype.I = function () {
                ...
                typeof c === "function" ? c = new c("unhandledrejection", {
                    cancelable: !0
                }) : typeof d === "function" ? c = new d("unhandledrejection", {
                    cancelable: !0
            ...
            b.all = function (c) {
                ...
                return g.done ? f([]) : new b(function (l, m) {
                    ...
                    var n = [],
                        q = 0;
                    do n.push(void 0), q++, f(g.value).s(D(n.length - 1), m), g = d.next(); while (!g.done)
                })
            };
            return b
        });
...
<script src="https://cdn.jsdelivr.net/gh/bubbls/youtube-playables@main/gamesnacks.js" data-target-origin="https://gamesnacks.com" data-user-activity-metrics data-run-slotcar-ads-in-game-center data-rewarded-monetizable data-interstitial-monetizable data-game-over-monetizable nonce="CA2QrendWiTeO_qSXS8GQQ"></script>
<meta name="robots" content="noindex, nofollow">
<meta charset="utf-8">
<title>Cocos Creator | Slimes mobile main</title>
...
<body>
    ...
    <!-- GS 2.0 API doesn't need to be loaded by the html -->
    <!-- <script async src="https://embed.gamesnacks.com/assets/js/gamesnacks.js" data-environment="test"></script> -->
    <!-- Polyfills bundle. -->
